...
const LoginPage = () => {
  ...
  return (
    ...
    justify-center gap-8 sm:justify-evenly max-sm:flex-col bg-gray-900'>
      ...
      <img src={assets.logo_big} alt="" className='w-[min(30vw,250px)]' />
        ...
        <form onSubmit={onSubmitHandler} className='border-2 bg-gray-950 text-white border-gray-500 p-6 flex
            ...
            {assets.arrow_icon} alt="" className='w-5 cursor-pointer'/>
              ...
              {!isDataSubmitted && (
                  <>
                    ...
                    placeholder='Email Address' required className='p-2 border
                     border-gray-500 rounded-md focus:outline-none focus:ring-2
                      focus:ring-indigo-500' />

                    <input onChange={(e) => setPassword(e.target.value)} value={password} type="password"
                    placeholder='Password' required className='p-2 border
                     border-gray-500 rounded-md focus:outline-none focus:ring-2
                      focus:ring-indigo-500' />
                  </>
                )}
              ...
              {currState === "Sign up" && isDataSubmitted && (
                ...
                className='p-2 border border-gray-500 rounded-md focus:outline-none
                focus:ring-2 focus:ring-indigo-500' placeholder
                ='provide a short bio...' required></textarea>
              )
            }

            <button className='py-3 bg-linear-to-r from-purple-400
            to-violet-600 text-white rounded-md cursor-pointer' type='submit'>
